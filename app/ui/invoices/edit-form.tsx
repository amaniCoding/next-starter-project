  ...
  return (
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6" aria-describedby="error-message">
        ...
        <fieldset>
          ...
          <div id="status-error" aria-live="polite">
            ...
            <p className="mt-2 text-sm text-red-500" id='error-message' aria-live="polite">{state.message}</p>
        </fieldset>
      </div>
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit" className="bg-pink-700 hover:bg-pink-600 focus:bg-pink-600">Edit Invoice</Button>
      </div>
    </form>
  );
}
